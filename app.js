...
app.all('/fibonacci', (req, resp) => {
  ...
  resp.setHeader('Content-Type', 'application/json');
  resp.end(JSON.stringify("A series of numbers in which each number ( Fibonacci number ) is the sum of the two preceding numbers. The simplest is the series 1, 1, 2, 3, 5, 8"));
});
